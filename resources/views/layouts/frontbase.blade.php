...
<!-- About-2 Area End -->
<section class="wantToWork-area section-bg3" data-background="{{asset('asset/home')}}/assets/img/gallery/section_bg01.png">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-cat text-center mb-50">
                    <div class="cat-icon">
                        <img src="{{asset('asset/home')}}/assets/img/icon/services1.svg" alt="">
                    </div>
                    <div class="cat-cap">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-cat text-center mb-50">
                    <div class="cat-icon">
                        <img src="{{asset('asset/home')}}/assets/img/icon/services2.svg" alt="">
                    </div>
                    <div class="cat-cap">
                        <h5><a href="services.html">Physical Activity</a></h5>
                        <p>Praesent porttitor, nulla vitae  posuere iaculis, arcu nisl dignissim dolor, a pretium mi  sem ut ipsum.</p>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-cat text-center mb-50">
                    <div class="cat-icon">
                        <img src="{{asset('asset/home')}}/assets/img/icon/services3.svg" alt="">
                    </div>
                    <div class="cat-cap">
                        <h5><a href="services.html">Physical Activity</a></h5>
                        <p>Praesent porttitor, nulla vitae  posuere iaculis, arcu nisl dignissim dolor, a pretium mi  sem ut ipsum.</p>
                    ...
                    <div class="h1-testimonial-active dot-style">
                        ...
                        <div class="single-testimonial position-relative">
                            <div class="testimonial-caption">
                                <img src="{{asset('asset/home')}}/assets/img/icon/quotes-sign.png" alt="" class="quotes-sign">
                            ...
                            <div class="testimonial-founder d-flex align-items-center">
                                <div class="founder-img">
                                    <img src="{{asset('asset/home')}}/assets/img/icon/testimonial.png" alt="">
                                </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="home-blog-single mb-40">
                    <div class="blog-img-cap">
                        <div class="blog-img">
                            <img src="{{asset('asset/home')}}/assets/img/gallery/blog1.png" alt="">
                        </div>
                        <div class="blog-cap">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="home-blog-single mb-40">
                    <div class="blog-img-cap">
                        <div class="blog-img">
                            <img src="{{asset('asset/home')}}/assets/img/gallery/blog2.png" alt="">
                        </div>
                        <div class="blog-cap">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="home-blog-single mb-40">
                    <div class="blog-img-cap">
                        <div class="blog-img">
                            <img src="{{asset('asset/home')}}/assets/img/gallery/blog3.png" alt="">
                        </div>
                        <div class="blog-cap">
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="about-img">
                        <div class="about-font-img">
                            <img src="{{asset('asset/home')}}/assets/img/gallery/about2.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
